...
class Test_Ue(unittest.TestCase):
	...
	def test_ajouter_supprimer(self):
		...
		self.assertEqual(cible.listeCm,[])
		self.assertEqual(cible.nombreSeance, 0)
		self.assertEqual(len(cible.listeSeance),0)
