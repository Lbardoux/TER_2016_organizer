...
class Autre(Seance.Seance):
	...
	@author : Liu Zhuying
	"""
	def __init__(self, idAutre, idGroupe, duree, idEnseignant = 0, description = ""):
		"""
		...
		@param duree : la duree qui aura cet Autre
		...
		"""
		super(Autre, self).__init__(idAutre, idGroupe, duree, idEnseignant, description)
	#fin __init__
